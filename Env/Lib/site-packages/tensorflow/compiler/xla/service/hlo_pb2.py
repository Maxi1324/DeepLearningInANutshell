...
_HLOMODULEPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='profile_info', full_name='xla.HloModuleProto.profile_info', index=12,
...
_ENTRYFUNCTIONATTRIBUTES_BUFFERPARAMETERATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lmhlo_param_shape_index', full_name='xla.EntryFunctionAttributes.BufferParameterAttributes.lmhlo_param_shape_index', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lmhlo_constant_name', full_name='xla.EntryFunctionAttributes.BufferParameterAttributes.lmhlo_constant_name', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lmhlo_must_alias', full_name='xla.EntryFunctionAttributes.BufferParameterAttributes.lmhlo_must_alias', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lmhlo_output_index', full_name='xla.EntryFunctionAttributes.BufferParameterAttributes.lmhlo_output_index', index=4,
