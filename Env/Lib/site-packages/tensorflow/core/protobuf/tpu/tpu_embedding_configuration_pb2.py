...
_TPUEMBEDDINGCONFIGURATION = _descriptor.Descriptor(
  ...
  nested_types=[_TPUEMBEDDINGCONFIGURATION_TABLEDESCRIPTOR, _TPUEMBEDDINGCONFIGURATION_FEATUREDESCRIPTOR, ],
  enum_types=[
