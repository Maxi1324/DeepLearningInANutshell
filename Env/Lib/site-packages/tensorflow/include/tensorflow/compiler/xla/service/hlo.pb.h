...
constexpr HloModuleProto_ProfileType HloModuleProto_ProfileType_ProfileType_MAX = HloModuleProto_ProfileType_LAYOUT;
...
constexpr CustomCallApiVersion CustomCallApiVersion_MAX = API_VERSION_STATUS_RETURNING;
