...
class CreateWorkerSessionRequest :
 ...
 public:
  ...
  enum : int {
    ...
    kCoordinationServiceConfigFieldNumber = 7,
  ...
  // .tensorflow.CoordinationServiceConfig coordination_service_config = 7;
  bool has_coordination_service_config() const;
  void clear_coordination_service_config();
  const ::tensorflow::CoordinationServiceConfig& coordination_service_config() const;
  ::tensorflow::CoordinationServiceConfig* release_coordination_service_config();
  ::tensorflow::CoordinationServiceConfig* mutable_coordination_service_config();
  void set_allocated_coordination_service_config(::tensorflow::CoordinationServiceConfig* coordination_service_config);
  void unsafe_arena_set_allocated_coordination_service_config(
      ::tensorflow::CoordinationServiceConfig* coordination_service_config);
  ::tensorflow::CoordinationServiceConfig* unsafe_arena_release_coordination_service_config();
 ...
 private:
  ...
  ::tensorflow::CoordinationServiceConfig* coordination_service_config_;
...
// .tensorflow.CoordinationServiceConfig coordination_service_config = 7;
inline bool CreateWorkerSessionRequest::has_coordination_service_config() const {
  return this != internal_default_instance() && coordination_service_config_ != nullptr;
}
inline const ::tensorflow::CoordinationServiceConfig& CreateWorkerSessionRequest::coordination_service_config() const {
  const ::tensorflow::CoordinationServiceConfig* p = coordination_service_config_;
  // @@protoc_insertion_point(field_get:tensorflow.CreateWorkerSessionRequest.coordination_service_config)
...
inline ::tensorflow::CoordinationServiceConfig* CreateWorkerSessionRequest::release_coordination_service_config() {
  // @@protoc_insertion_point(field_release:tensorflow.CreateWorkerSessionRequest.coordination_service_config)
  
  ::tensorflow::CoordinationServiceConfig* temp = coordination_service_config_;
  if (GetArenaNoVirtual() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  coordination_service_config_ = nullptr;
  return temp;
}
inline ::tensorflow::CoordinationServiceConfig* CreateWorkerSessionRequest::unsafe_arena_release_coordination_service_config() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.CreateWorkerSessionRequest.coordination_service_config)
  
  ::tensorflow::CoordinationServiceConfig* temp = coordination_service_config_;
  coordination_service_config_ = nullptr;
  return temp;
}
inline ::tensorflow::CoordinationServiceConfig* CreateWorkerSessionRequest::mutable_coordination_service_config() {
  
  if (coordination_service_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::CoordinationServiceConfig>(GetArenaNoVirtual());
    coordination_service_config_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.CreateWorkerSessionRequest.coordination_service_config)
  return coordination_service_config_;
}
inline void CreateWorkerSessionRequest::set_allocated_coordination_service_config(::tensorflow::CoordinationServiceConfig* coordination_service_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(coordination_service_config_);
  }
  if (coordination_service_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      coordination_service_config = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, coordination_service_config, submessage_arena);
    }
    
  } else {
    
  }
  coordination_service_config_ = coordination_service_config;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.CreateWorkerSessionRequest.coordination_service_config)
}
