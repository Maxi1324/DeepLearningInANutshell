...
def dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch(sample_indices_or_row_lengths, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners=[], name=None):
  ...
  Args:
    sample_indices_or_row_lengths: A list of at least 1 `Tensor` objects with the same type in: `int32`, `int64`.
      ...
      int32 internally.
    embedding_indices: A list with the same length as `sample_indices_or_row_lengths` of `Tensor` objects with the same type in: `int32`, `int64`.
      A list of rank 1 Tensors, indices into the embedding
      tables. Both int32 and int64 are allowed and will be converted to
      int32 internally.
    aggregation_weights: A list with the same length as `sample_indices_or_row_lengths` of `Tensor` objects with the same type in: `float32`, `float64`.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        sample_indices_or_row_lengths, embedding_indices, aggregation_weights,
    ...
    try:
      return dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(
          sample_indices_or_row_lengths, embedding_indices,
          aggregation_weights, mode_override, device_ordinal,
          combiners=combiners, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
  # Add nodes to the TensorFlow graph.
  if not isinstance(sample_indices_or_row_lengths, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices_or_row_lengths' argument to "
        "'dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % sample_indices_or_row_lengths)
  _attr_N = len(sample_indices_or_row_lengths)
  ...
  if len(embedding_indices) != _attr_N:
    raise ValueError(
        ...
        "must match length %d of argument 'sample_indices_or_row_lengths'." %
  ...
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "DynamicEnqueueTPUEmbeddingArbitraryTensorBatch", sample_indices_or_row_lengths=sample_indices_or_row_lengths,
...
def dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(sample_indices_or_row_lengths, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, name, ctx):
  if not isinstance(sample_indices_or_row_lengths, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices_or_row_lengths' argument to "
        "'dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % sample_indices_or_row_lengths)
  ...
  if not isinstance(combiners, (list, tuple)):
    raise TypeError(
        ...
        "'dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % combiners)
  combiners = [_execute.make_str(_s, "combiners") for _s in combiners]
  _attr_T1, sample_indices_or_row_lengths = _execute.args_to_matching_eager(list(sample_indices_or_row_lengths), ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  ...
  _inputs_flat = list(sample_indices_or_row_lengths) + list(embedding_indices) + list(aggregation_weights) + [mode_override, device_ordinal]
...
def enqueue_tpu_embedding_arbitrary_tensor_batch(sample_indices_or_row_lengths, embedding_indices, aggregation_weights, mode_override, device_ordinal=-1, combiners=[], name=None):
  r"""Eases the porting of code that uses tf.nn.embedding_lookup_sparse().
  ...
  if not isinstance(sample_indices_or_row_lengths, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices_or_row_lengths' argument to "
        "'enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % sample_indices_or_row_lengths)
  _attr_N = len(sample_indices_or_row_lengths)
  if not isinstance(embedding_indices, (list, tuple)):
    raise TypeError(
        "Expected list for 'embedding_indices' argument to "
  ...
  combiners = [_execute.make_str(_s, "combiners") for _s in combiners]
  _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "EnqueueTPUEmbeddingArbitraryTensorBatch", sample_indices_or_row_lengths=sample_indices_or_row_lengths,
                                                   embedding_indices=embedding_indices,
                                                   aggregation_weights=aggregation_weights,
                                                   mode_override=mode_override,
                                                   device_ordinal=device_ordinal,
...
def enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(sample_indices_or_row_lengths, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, name, ctx):
  if not isinstance(sample_indices_or_row_lengths, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices_or_row_lengths' argument to "
        "'enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % sample_indices_or_row_lengths)
  ...
  _attr_T3, aggregation_weights = _execute.args_to_matching_eager(list(aggregation_weights), ctx, [_dtypes.float32, _dtypes.float64, ], _dtypes.float32)
  mode_override = _ops.convert_to_tensor(mode_override, _dtypes.string)
  _inputs_flat = list(sample_indices_or_row_lengths) + list(embedding_indices) + list(aggregation_weights) + [mode_override]
  _attrs = ("T1", _attr_T1, "T2", _attr_T2, "T3", _attr_T3, "N", _attr_N,
